...
parser.add_argument('--url', help='Torchserve model URL', type=str, default=f'http://127.0.0.1:8080/predictions/mnist_neuron')
parser.add_argument('--num_thread', type=int, default=32, help='Number of threads invoking the model URL')
...
def one_thread(pred):
    ...
    while True:
        ...
        data = {'data': open('/home/ubuntu/emlov2-session-09/1.png', 'rb')}
